...
import static app.exito.driver.AppiumAndroidDriver.driver;
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        try {
            ...
            actor.attemptsTo(
                    ...
                    Click.on(INP_ANIO),
                    Enter.theValue(ANIO).into(INP_ANIO),
                    Click.on(INP_ANIO),
                    Click.on(INP_MES),
                   // Click.on(SELECT_MES),
                    Enter.theValue(MES).into(INP_MES),
                    Click.on(INP_MES),
                    Click.on(INP_DIA),
                   // Click.on(SELECT_DIA),
                    Enter.theValue(DIA).into(INP_DIA),
                    Click.on(INP_DIA),
